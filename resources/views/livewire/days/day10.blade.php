<x-ui.day-container :dayNumber="$dayNumber" title="Drawer & Toast"
    description="Navigation panels and notification system for modern applications">
    {{-- Toast Container --}}
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <x-ui.drawer position="left" width="md">
                            <x-slot:trigger>
                                <button
                                    class="w-full px-4 py-2.5 bg-secondary text-secondary-foreground rounded-lg text-sm font-medium hover:bg-secondary/80 transition-colors">
                        ...
                        <x-ui.drawer position="right" width="lg">
                            ...
                            <x-slot:footer>
                                <div class="flex gap-3">
                                    <button @click="close()"
                                        class="flex-1 px-4 py-2 bg-secondary text-secondary-foreground rounded-lg text-sm font-medium hover:bg-secondary/80 transition-colors">
                                        Cancel
                                    </button>
                                    <button
                                        class="flex-1 px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors">
                                        Save
                                    </button>
                                </div>
                            </x-slot:footer>
                        ...
                        <x-ui.drawer position="top" height="md">
                            ...
                            <div class="p-6">
                                <x-ui.input icon="search" placeholder="Search for anything..." size="lg" />
                                <div class="mt-4 flex flex-wrap gap-2">
                                    <span class="text-xs text-muted-foreground">Recent:</span>
                                    <button
                                        class="px-2 py-1 text-xs bg-accent rounded hover:bg-accent/80">Dashboard</button>
                                    <button
                                        class="px-2 py-1 text-xs bg-accent rounded hover:bg-accent/80">Users</button>
                                    <button
                                        class="px-2 py-1 text-xs bg-accent rounded hover:bg-accent/80">Settings</button>
                                </div>
                            </div>
                        </x-ui.drawer>
                        ...
                        <x-ui.drawer position="bottom" height="md">
                            ...
                            <div class="p-6">
                                <div class="grid grid-cols-4 gap-4">
                                    <button
                                        class="flex flex-col items-center gap-2 p-4 rounded-lg hover:bg-accent transition-colors">
                                        <div
                                            class="size-12 bg-primary/10 rounded-full flex items-center justify-center">
                                    ...
                                    <button
                                        class="flex flex-col items-center gap-2 p-4 rounded-lg hover:bg-accent transition-colors">
                                        <div
                                            class="size-12 bg-green-500/10 rounded-full flex items-center justify-center">
                                    ...
                                    <button
                                        class="flex flex-col items-center gap-2 p-4 rounded-lg hover:bg-accent transition-colors">
                                        <div
                                            class="size-12 bg-blue-500/10 rounded-full flex items-center justify-center">
                                    ...
                                    <button
                                        class="flex flex-col items-center gap-2 p-4 rounded-lg hover:bg-accent transition-colors">
                                        <div
                                            class="size-12 bg-yellow-500/10 rounded-full flex items-center justify-center">
                ...
                <div>
                    ...
                    <div class="p-4 bg-muted/30 rounded-lg space-y-3">
                        ...
                        <div class="flex gap-2">
                            <x-ui.button @click="$dispatch('open-drawer')" variant="outline">
                                $dispatch('open-drawer')
                            </x-ui.button>
                            <x-ui.button @click="$dispatch('close-drawer')" variant="outline">
