                ...
                <div class="space-y-4">
                    ...
                    <x-ui.tabs default="overview">
                        <x-ui.tabs.list variant="pills">
                            ...
                            <x-ui.tabs.trigger tab="analytics" variant="pills" icon="bar-chart">Analytics</x-ui.tabs.trigger>
                            <x-ui.tabs.trigger tab="reports" variant="pills" icon="file-text">Reports</x-ui.tabs.trigger>
                        </x-ui.tabs.list>
